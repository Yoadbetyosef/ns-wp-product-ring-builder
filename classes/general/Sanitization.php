...
class Sanitization{
  ...
  /******************************************/
  public function Int($int, $negative = false){
  ...
  /***** SanitizeEmail function start from here *********/
  /******************************************/
  public function Username($username, $slength = 1, $elength = 999){
  ...
  /******************************************/
  public function Textfield($text, $slength = 1, $elength = 9999999){
  ...
  /******************************************/
  public function Textarea($text, $bballowedtags = false){
    if(isset($text) && $text && $text != " "){
