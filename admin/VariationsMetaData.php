...
class VariationsMetaData extends \OTW\WooRingBuilder\Plugin{
  ...
  public function __construct(){
    ...
    /******************************************/
    /***** save_product_variation function start from here *********/
    /******************************************/
    ...
    /******************************************/
    /***** get_variation_fields function start from here *********/
    /******************************************/
    public function get_variation_fields(){

        return array(
            /*'otw_woo_variation_image' => array(
                'meta_key' => 'otw_woo_variation_image',
                'field_title' => 'Image',
                'field_type' => 'image',
            ),*/
