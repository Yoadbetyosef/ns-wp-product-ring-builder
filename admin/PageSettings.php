...
class PageSettings extends \OTW\WooRingBuilder\Plugin{
		...
		<form action="" method="post">
			...
			<div class="postbox" id="<?php echo $this->prefix( 'vue_app' ); ?>">
				...
				<h3 class="hndle ui-sortable-handle">
					<span><?php _e( 'GCP Builder General Setting', 'otw-woo-ring-builder-td' ); ?></span>
				</h3>
			...
			<div class="postbox" id="<?php echo $this->prefix( 'vue_app_diamond_api' ); ?>">
				<div class="postbox-header">                    
				<h3 class="hndle ui-sortable-handle">
					<span><?php _e( 'Diamond APIs', 'otw-woo-ring-builder-td' ); ?></span>
				</h3>
	...
	public function page_tabs( $is_tabs = false ) {
		...
		<nav class="nav-tab-wrapper" style="margin-bottom:20px;">
			<a href="?page=<?php echo $this->prefix; ?>" class="nav-tab 
										<?php
										if ( $tab === null ) :
											?>
				nav-tab-active<?php endif; ?>"><?php _e( 'Default Tab', 'otw-woo-ring-builder-td' ); ?></a>
			<a href="?page=<?php echo $this->prefix; ?>&tab=settings" class="nav-tab 
										<?php
										if ( $tab === 'settings' ) :
											?>
				nav-tab-active<?php endif; ?>"><?php _e( 'Settings', 'otw-woo-ring-builder-td' ); ?></a>
			<a href="?page=<?php echo $this->prefix; ?>&tab=tools" class="nav-tab 
										<?php
										if ( $tab === 'tools' ) :
											?>
				nav-tab-active<?php endif; ?>"><?php _e( 'Tools', 'otw-woo-ring-builder-td' ); ?></a>
		</nav>
			<?php
		}
	...
	public function input_handle() {
		...
		if ( isset( $_POST[ $this->prefix( 'nonce' ) ] ) &&
			wp_verify_nonce( $_POST[ $this->prefix( 'nonce' ) ], $this->prefix( 'nonce' ) )
		) {
